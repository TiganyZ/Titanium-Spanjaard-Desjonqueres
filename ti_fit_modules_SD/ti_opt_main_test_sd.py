...
a = 1.247525
B = 0.886571
bb = 0.565  #np.array( [ 24.85, 1.247525, 0.886571, 0.565  ] )
scl_const =1. 
par_arr = np.array([ A*scl_const, a, B*scl_const, bb, 1.0]) # np.array( [21.28898933,  1.16721662 , 1.08835262 , 0.61034674,  1.        ])
...
a = 1.2
B = 1.075
bb = 0.6  #np.array( [ 24.85, 1.247525, 0.886571, 0.565  ] )
scl =1.0
...
#b = 0.5
scl = 1.#0.5
par_arr = np.array([ A*scl, a, B*scl, bb, 1.0]) 
par_arr = np.array([ 24.85, 1.247525, 0.886571, 0.565, 1.  ] )


spanjdecpp=pR0/alat_ideal

par_arr = np.array([ 11125, spanjdecpp, 0, 0, 0  ] )
...
#par_arr, alat_diff, clat_diff, coa_diff, min_coa, min_alat, min_vol, etot_bcc, etot_bcc2, etot_omega, etot_fcc  = outp.output_script(
#            maxit, npass, par_arr, ddcoeffs, pair_pot_bank, ddcoeff_bank, 
#                              total_error, dddeltanorm, pR0, qR0)
#exit(1)
#for i in range(maxit):
#    npass, par_arr, ddcoeffs, pair_pot_bank, ddcoeff_bank, total_error = vp.vary_params(maxit, npass, par_arr, ddcoeffs, pair_pot_bank, ddcoeff_bank, 
 #                                                                                                           total_error, dddeltanorm, pR0, qR0)
